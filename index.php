  ...
  <body>     
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Bem-vindo (a) ao Painel Administrativo Tech Store</h1>
        <p class="lead">Escolha uma opção no menu acima para que possa executar as funcionalidades do nosso painel.<br> Trabalho realizado sob orientação do Professor Carlos Ribeiro.</p>
      </div>
